...
def play_sound():
        playsound("C:/Tic-Tac-Toe-Networking-master/sound_effects/start_game.mp3")
...
def x_sound():
    playsound("C:/Tic-Tac-Toe-Networking-master/sound_effects/drawing_x.mp3")
...
def draw_o():
    playsound("C:/Tic-Tac-Toe-Networking-master/sound_effects/drawing_o.mp3")
    drawer.pd()
    drawer.circle(20)
    drawer.pu()
